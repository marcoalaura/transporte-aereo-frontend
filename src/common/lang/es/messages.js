...
export default {
  ...
  login: {
    ...
    title_nit: 'Ingrese como Administrador de su Operador',
  ...
  common: {
    ...
    actions: 'Acciones',
    close: 'Cerrar',
    assignCrew: 'Asignar Tripulación'
  },
  entity: {
    title: 'Entidades',
  ...
  aeropuerto: {
    ...
    crud: {
      ...
      municipio: 'Municipio',
      departamento: 'Departamento',
      certificado_aerodromo: 'Certificado Aeródromo',
      estado: 'Estado',
      clave_referencia: 'Clave de Referencia',
      categoria_ssei: 'Categoría SSEI',
      lapso_entre_despegues: 'Lapso entre Despegues minutos'
    }
  },
  aeronave: {
    title: 'Aeronaves',
    ...
    crud: {
      ...
      capacidad_maxima_asientos: 'Capacidad máxima de asientos',
      capacidad_carga: 'Peso Máximo Bruto de Despegue',
      ads_b: 'ADS-B',
      descripcion: 'Descripción',
      estado: 'Estado',
